...
function createFixture(streamingMessage?: AssistantMessage) {
	...
	const ctx = {
		...
		statusLine: { invalidate: vi.fn(), setHookStatus, markActivityStart: vi.fn(), markActivityEnd: vi.fn() },
	...
	return { controller, ctx, setHookStatus, showPinnedError, clearPinnedError, streamingComponent, componentCalls };
}
